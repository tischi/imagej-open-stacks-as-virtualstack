...
/**
 * Created by tischi on 29/10/16.
 */

public class TiffDecoderExtension {
    ...
    public TiffDecoderExtension(String directory, String name) {
        this.directory = directory;
        this.name = name;
    }

    public FileInfo getFirstIFD() throws IOException {
        long ifdOffset;
        ...
        while (ifdOffset>0L) {
            ...
            ifdOffset = 0L;   // ignore extra IFDs
        }
        if (list.size()==0) {
            in.close();
            return null;
